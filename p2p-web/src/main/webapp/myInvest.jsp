     ...
     <div class="deal-data">
      <dl>
       ...
       <span class="deal-money">投资金额(元)</span>
		  ...
		  <c:forEach items="${bidInfoList}" var="b" >
			  <dd>
				  <div class="deal-time"><fmt:formatDate value="${b.bidTime}" pattern="yyyy-MM-dd HH-mm-ss"/></div>
				  <div class="deal-name">${b.loanInfo.productName}</div>
				  <div class="deal-type" style="width:120px">
					  <!-- 判断投资状态是否为1，即成功 -->
					  <c:if test="${b.bidStatus eq 1}">
					  投资成功
					  </c:if>
				  ...
				  <div class="deal-money">${b.bidMoney}</div>
			  </dd>
