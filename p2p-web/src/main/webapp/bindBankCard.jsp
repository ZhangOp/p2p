...
<head>
    ...
    <script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/js/bindBankCard.js"></script>
        ...
        <div class="homeWap">
            ...
            <div class="login-cnt reg-body clearfix">
                <div class="fl">
                    ...
                    <div class="login-form reg-form">
                        ...
                        <div class="login-box clearfix" style="z-index:100;">
                            <label>银行卡号</label>
                            <input type="text" id="cardNo" name="realName" class="input_text" maxlength="25" placeholder="请输入您的银行卡号" autocomplete="off" onblur="checkRealName();"/>
                            <span class="loading" style="display:none;"></span>
                            <span id="cardNoOk" class="ok" style="display:none;"></span>
                            <div id="cardNoErr" class="form-hint" style="display:none;"></div>
                        </div>
                        <div class="login-box clearfix" style="z-index:100;">
                            <label>真实姓名</label>
                        ...
                        <div class="login-box clearfix" style="z-index:80;">
                            ...
                            <label>银行预留手机号</label>
                            <input type="text" id="phone" name="phone" class="input_text" maxlength="21"  placeholder="请输入银行预留手机号码" onblur="checkReplayIdCard()"/>
                ...
                <input id="agree" name="agree" type="checkbox"/>我已阅读并同意<a href="javascript:alertBox('mask','agreement');"><font style="color: red;">《动力金融网&trade;实名认证服务协议》</font></a>
                        ...
                        <div class="bn-login">
                            <button class="fail" id="btnRegist" disabled onclick="javascript:verifyBankCard();">认&nbsp;&nbsp;证</button>
                        </div>
                    </div>
                </div>
                <div class="reg-right">
