      ...
      <div class="login-cnt clearfix">
        <div class="login-form">
		     ...
		     <div id="showCaptcha" class="yzm-box" style="display:block;">
			 	...
			 	<%--<input id="captcha" type="text" class="yzm" placeholder="点击右侧获取验证码"/>--%>
        ...
        <div class="login-right">
          ...
          <div class="top-txt">
		          动力金融网，便捷的投资平台
			<br/><br/>
			加入动力金融网<br/>坐享<span class="historyAverageRate">12.7</span>%历史年化收益
          </div>
          ...
          <div class="bn-reg" id="quickRegBtn">
           ...
           <ul class="clearfix">
            <li><i></i>
              <h3>优选投资计划</h3>
              <p>
              	历史年化收益<span class="historyAverageRate">12.7</span>%<br/>
